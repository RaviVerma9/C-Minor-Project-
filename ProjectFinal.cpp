...
//Our Complete Class Covid -->
class variable{
	public:
		
    int task, taskforcb;;
    unsigned long long mobile,mobile1,password,password1,Age,aadhar,back,date,birthdate,day,month,year,curda,curmo,curye,menu,y;;
    char Name[50];
    char Surname[50];
...
//Function for Main Menu -->	
    ...
    //For Registration Work our Function -->
void registration()
{	
system ("cls");
...
//			 get output from file **
          ...
          outfile>>curda>>curmo>>curye;
          cout<<"\t\t\t Current Date => "<< curda << "/" << curmo << "/" << curye <<endl;
 ...
 //For login Work Our Function -->
void login(){
	
//	 unsigned long long mobile1 ,password1,back;
...
void booking()
	{   system("Color E");
		int m,x;
		 ...
		 cout<<"\n\t\t\tDate of Vaccination is:- "<<curda<<"/"<<curmo<<"/"<< curye<<endl;
	...
	void certificate()
	{
		   ...
		   cout<<"Dear "<<Name<<" "<<Surname;
		   cout<<"\nYou are successfully vaccinated on "<<curda+5<<"/"<<curmo<<"/"<<curye<<endl;
		   
		   cout<<"\n\t\tBENEFICIARY DETAILS ";
		   cout<<"Beneficiary Name:- "<<Name<<" "<<Surname<<endl;
		   cout<<"Age:- "<<Age<<endl;
		   cout<<"ID Verified:- "<<aadhar<<endl;
